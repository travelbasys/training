 ...
 * Jede Instanz der Klasse wird gezählt; der Instanzenzähler kann abgefragt
 * und von außen verändert werden.
 * 
 * @author tba
 *
 */
public class HelloWorldUI {
	 ...
	 * Business Objekt nach der gültigen Message gefragt wird und dieser
	 ...
	 * 
	 * @param i	der neue Wert des Instanzenzählers; muss gerade sein!
	 * 
