...
import de.travelbasys.training.util.widgets.FXCalendarCell.DateCell;
import de.travelbasys.training.util.widgets.FXCalendarCell.WeekCell;
import de.travelbasys.training.util.widgets.FXCalendarControls.BaseNavigatorArrowButton;
import de.travelbasys.training.util.widgets.FXCalendarControls.NormalButton;
...
public class BasePane extends Group {
	...
	private void configureNavigator() {
		...
		BaseNavigatorArrowButton nextMonthBtn = new FXCalendarControls().new BaseNavigatorArrowButton(Side.RIGHT, datePicker.getBaseColor());
