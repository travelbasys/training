...
public class ReportRecord {
	...
	/**
	 * Die Textbezeichnung des gewählten Menüs, z.B. "Auftragsstatistik" für 8006.
	 */
	public String menuText;
	
	/**
	 * Die Stunde, in der die Abrufe erfolgten. "10" bedeutet Abrufe von 10:00 bis 10:59 Uhr.
	 */
	 ...
	 * <p>
	 * Beispiel: 
	 * <code>01.01.2012;3101;RBSweb;Anzeigen Ran/RBE;8;4</code>
	 * </p>
	 */
	public String toString(){
		
		return datum + "; " + menu +"; " +menuTyp +"; " + menuText +"; " + stunde +"; " + anzStunde;
	}
}
