...
public class ComboBoxSample extends Application {
    ...
    private final ObservableList<Text> texts = FXCollections.observableArrayList(new Text("abc"), new Text("efg"));
    ...
    private void init(Stage primaryStage) {
        ...
        box2.getItems().addAll(new Text("abc"), new Text("efg"), new Text("jdk"));
        ...
        hbox.getChildren().addAll(uneditableComboBox, editableComboBox, box, box2);
